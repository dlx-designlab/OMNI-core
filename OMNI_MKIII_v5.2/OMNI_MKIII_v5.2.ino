...
const uint8_t  NetworkPower = 12; // Use for turning ON-OFF network module
//******** sakura LTE ******************************************************//
...
void setup()
{
 ...
 // while(1){ //debug
  ...
  Serial.println("initialzing LTE.");
  delay(100);
...
bool startLTE(){
  ...
  Serial.println("Out of LTE tries.");
  return false; 
}

void enqueueTemperature()
{
 sakuraio.enqueueTx((uint8_t)4, temp1);
 sakuraio.enqueueTx((uint8_t)5, temp2);
 sakuraio.enqueueTx((uint8_t)6, temp3);
