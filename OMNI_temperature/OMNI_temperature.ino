...
const uint8_t  temperature1 = 11;
const uint8_t  temperature2 = 10;
const uint8_t  temperature3 = 5;//4
...
//******** temperature ******************************************************//
OneWire oneWire1(temperature1);
OneWire oneWire2(temperature2);
OneWire oneWire3(temperature3);
DallasTemperature temperatureSensors1(&oneWire1);
DallasTemperature temperatureSensors2(&oneWire2);
DallasTemperature temperatureSensors3(&oneWire3);

float temperatureValue1 = 0.f;
float temperatureValue2 = 0.f;
float temperatureValue3 = 0.f;
...
void setup()
{
 ...
 // while(1){ //debug
  ...
  Serial.print("temp1 ");  Serial.println(temperatureValue1, 6);
  Serial.print("temp2 ");Serial.println(temperatureValue2, 6);
  Serial.print("temp3 ");Serial.println(temperatureValue3, 6);
  delay(500);
  //}
...
Serial.println("GPS -----------");
 ...
 Serial.println("Temperatures -----------");
 Serial.println(temperatureValue1, 6);
 Serial.println(temperatureValue2, 6);
 Serial.println(temperatureValue3, 6);
 Serial.println("\n");
 delay(100);
...
void initTemperatureSensors()
{
  ...
  temperatureSensors1.setWaitForConversion(true);
  temperatureSensors2.begin();
  temperatureSensors2.setWaitForConversion(true);
  temperatureSensors3.begin();
  temperatureSensors3.setWaitForConversion(true);
}
...
void getTemperature()
{
  ...
  temperatureValue1 = temperatureSensors1.getTempCByIndex(0);
  temperatureSensors2.requestTemperatures();
  temperatureValue2 = temperatureSensors2.getTempCByIndex(0);
  temperatureSensors3.requestTemperatures();
  temperatureValue3 = temperatureSensors3.getTempCByIndex(0);
